...
public class MapLibreMapsPlugin implements FlutterPlugin, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    // 🔥 FORCE STARTUP CONNECTIVITY
    // This tells MapLibre to ignore the OS Wi-Fi state and always stay 'online' 
    // for internal 127.0.0.1 requests.
    try {
      org.maplibre.android.net.ConnectivityReceiver.instance(binding.getApplicationContext()).setConnected(true);
    } catch (Exception e) {
